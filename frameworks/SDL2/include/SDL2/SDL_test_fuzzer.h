...
/**
 * \returns random long double in range [0.0 - 1.0[
 */
long double SDLTest_RandomUnitlong double(void);
...
/**
 * \returns random long double.
 *
 */
long double SDLTest_Randomlong double(void);
