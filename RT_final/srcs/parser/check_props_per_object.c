...
void	check_plane_props(t_rt *rt)
{
	...
	char *accepted[5] = {"position", "normal", "color", "translation", "rotation"};
...
void	check_sphere_props(t_rt *rt)
{
	...
	char *accepted[5] = {"position", "rayon", "color", "translation"};
...
void	check_cylinder_props(t_rt *rt)
{
	...
	char *accepted[6] = {"position", "rayon", "axe", "color", "translation", "rotation"};
	char *required[2] = {"position", "rayon"};
...
void	check_cone_props(t_rt *rt)
{
	...
	char *accepted[6] = {"position", "axe", "k", "color", "translation", "rotation"};
...
void	check_torus_props(t_rt *rt)
{
	...
	char *accepted[7] = {"position", "axe", "k", "l", "color", "translation", "rotation"};
